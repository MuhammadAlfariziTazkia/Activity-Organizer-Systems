        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    <input name="start_time" type="text" class="form-control" id="start_time" required value="{{$schedule->start_time}}">
                </div>
                <div class="mb-3">
                    <label for="end_time" class="form-label">End Time</label>
                    <input name="end_time" type="text" class="form-control" id="end_time" value="{{$schedule->end_time}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
